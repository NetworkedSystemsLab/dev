...
if("TRUE" STREQUAL "TRUE")
  set(pathing_SOURCE_PREFIX /home/nvidia/catkin_ws/src/pathing)
  set(pathing_DEVEL_PREFIX /home/nvidia/catkin_ws/devel)
  set(pathing_INSTALL_PREFIX "")
  set(pathing_PREFIX ${pathing_DEVEL_PREFIX})
else()
  set(pathing_SOURCE_PREFIX "")
  set(pathing_DEVEL_PREFIX "")
  set(pathing_INSTALL_PREFIX /home/nvidia/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pathing' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'nvidia <nvidia@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pathing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/pathing/${idir}'.  Ask the maintainer 'nvidia <nvidia@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND pathing_EXPORTED_TARGETS ${${pathing_dep}_EXPORTED_TARGETS})
endforeach()
